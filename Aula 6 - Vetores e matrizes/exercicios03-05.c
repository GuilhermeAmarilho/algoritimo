...
//questão 5 - Faça um programa em C que leia a idade e a altura de 5 pessoas, armazene cada informação no seu respectivo vetor. Imprima a idade e a altura na ordem inversa a ordem lida.
...
//sinto muito prof, não consegui concluir os dois desafios